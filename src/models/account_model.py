...
# Type variable for BankAccountModel subclasses
...
class BankAccountModel:
    ...
    _name: str
    _balance: float
    _interest_rate: float  # TODO: add interest rate into
    # bank account calculations within the server.
    _is_locked: bool
    ...
    def __init__(self, name: str, balance: float) -> None:
        ...
        BankAccountModel.bank_accounts += 1
...
class CheckingAccountModel(BankAccountModel):
...
class SavingsAccountModel(BankAccountModel):
...
class CDAccountModel(BankAccountModel):
    _term: int
    _interest_rate: float
    _is_matured: bool
...
if __name__ == "__main__":
    ...
    setup_logging()
    bank_account = CheckingAccountModel("Luis's Checking Account", 100.0)
